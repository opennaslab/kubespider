...
在步骤1下载代码后，打开Chrome，按如下步骤安装Kubespider Chrome插件并且设置(其中地址为`http://<server_ip>:3080`)： ![img](../images/kubespider-chrome-ext-install-zh.gif)

如我要追剧，直接右键，发送给Kubespider即可([示例网站](https://www.meijutt.tv/))： ![img](../images/kubespider-chrome-ext-usage-zh.png)
